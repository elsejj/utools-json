 ...
 */
export function run(filter, input, settings, scope) {
    try {
        ...
        wasm.run(ptr0, len0, ptr1, len1, addBorrowedObject(settings), addBorrowedObject(scope));
    } finally {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('jaq_play_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
